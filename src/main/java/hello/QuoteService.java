...
/**
 * 
 * You must supply the name of the cache. We named it "Quotes" for demonstration
 * purposes, but in production, it is recommended to pick an appropriately
 * descriptive name. This also means different methods can be associated with
 * different caches. This is useful if you have different configuration settings
 * for each cache, such as different expiration or eviction policies, etc.
 *
 */
...
public class QuoteService {
	...
	/**
	 * Determines whether the previous service method invocation resulted in a cache
	 * miss.
	 *
	 * @return a boolean value indicating whether the previous service method
	 *         invocation resulted in a cache miss.
	 */
